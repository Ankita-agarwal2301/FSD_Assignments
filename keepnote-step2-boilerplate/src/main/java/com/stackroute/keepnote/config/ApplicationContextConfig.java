...
//		dataSource.setPassword(System.getenv("MYSQL_PASSWORD"));
	...
	public LocalSessionFactoryBean getSessionFactory(DataSource datasource) throws IOException {
		...
		session.setAnnotatedClasses(Note.class);
		session.setHibernateProperties(property);
	...
	@Bean
	public HibernateTransactionManager getTransactionManaget(SessionFactory sess)
	{
		HibernateTransactionManager hbt = new HibernateTransactionManager();
		hbt.setSessionFactory(sess);
		return hbt;
